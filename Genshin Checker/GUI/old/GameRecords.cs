            ...
            try
            {
                ...
                if (account.EnkaNetwork.HasError)
                {
                    ...
                    if (account.GameRecords.Data != null) {
                        ...
                        Summary_UserIcon.Image = DrawControl.BitmapInterpolation(await Core.WebRequest.ImageGetRequest(account.GameRecords.Data.role.game_head_icon), Summary_UserIcon.Width, Summary_UserIcon.Height);
                    }
                    else
                    {
                ...
                {
                    Summary_UserIcon.Image = DrawControl.BitmapInterpolation(await Core.WebRequest.ImageGetRequest(EnkaData.Convert.AvaterIcon.GetIconURL(account.EnkaNetwork.Data.playerInfo.profilePicture.avatarId)), Summary_UserIcon.Width, Summary_UserIcon.Height);
