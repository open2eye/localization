...
namespace Genshin_Checker.Core
{
    public class RealTimeNote
    {
        ...
        public Genshin_Checker.Core.Store.RealTimeNote.Data Data { get; private set; } = new();
        ...
        private async void ServerUpdate_Tick(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (var ex in json.expeditions)
                {
                    ...
                    Data.RealTime.Expedition.Expeditions.Add(new Genshin_Checker.Core.Store.RealTimeNote.ExpeditionDetail()
                    {
...
namespace Genshin_Checker.Core.Store.RealTimeNote
{
    public class Meta
    {
